...
class DeliveryDetailUI extends StatefulWidget {
  FoodShopList? foodShopList;

  DeliveryDetailUI({super.key, this.foodShopList});

  @override
  State<DeliveryDetailUI> createState() => _DeliveryDetailUIState();
}

class _DeliveryDetailUIState extends State<DeliveryDetailUI> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: ListTile(
                  onTap: () {
                    _launchInBrowser(Uri.parse('https://www.google.com/maps/search/?api=1&query-' + widget.foodShopList!.shopLatitude + ',' + widget.foodShopList!.shopLongitude));
                  },
                  leading: Icon(
